from gene_discovery.models import GeneEntry
                    ...
                    for match_id, token_ids in matches:
                        if match_id not in match_ids:
                            ...
                            for i in range(len(token_ids)):
                                ...
                                # print(doc[token_ids[i]].sent)
                            # print(doc[token_ids[0]:token_ids[1]].start_char)
                            # print(doc[token_ids[0]:token_ids[1]].sent)
                            # print("==========================================")
                        match_ids.append(match_id)

                # texts.append(text)
# ss = nlp(' '.join(texts)).sents
